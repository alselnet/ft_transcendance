...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates/webserver')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
FRONTEND_REDIRECT_URI = config('FRONTEND_REDIRECT_URI')
...
TWILIO_PHONE_NUMBER = '+33652453352'
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [(os.environ.get('REDIS_HOST', 'redis'), int(os.environ.get('REDIS_PORT', 6380)))],
        },
    },
}